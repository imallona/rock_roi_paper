...
mouse_plus<-runFimo(set,tso_motif,skip_matched_sequence=TRUE,thresh=0.005) # need to change thresh otherwise doesn't show any results
...
human_plus_5<-runFimo(set,tso_motif_5,skip_matched_sequence=FALSE,thresh=0.0005) # need to change thresh otherwise doesn't show any results

human_plus_4<-runFimo(set,tso_motif_4,skip_matched_sequence=FALSE,thresh=0.0005) # need to change thresh otherwise doesn't show any results

...
pearson_corr<-cor(mouse_logcpm$mixing_unmod,mouse_logcpm$mixing_unmod_n1,method="pearson")
pearson_corr

# Dots with highest difference logcpms 

delta_mouse_logcpm<-data.frame(value=abs(mouse_logcpm$mixing_unmod-mouse_logcpm$mixing_unmod_n1))
...
ggplot(mouse_logcpm,aes(x=mixing_unmod,y=mixing_unmod_n1,label=label))+
...
pearson_corr<-cor(human_logcpm$mixing_unmod,human_logcpm$mixing_unmod_n1,method="pearson")
pearson_corr

# Dots with highest difference logcpms 

delta_human_logcpm<-data.frame(value=abs(human_logcpm$mixing_unmod-human_logcpm$mixing_unmod_n1))
...
ggplot(human_logcpm,aes(x=mixing_unmod,y=mixing_unmod_n1,label=label))+
  geom_point(alpha=0.2,size=0.5)+
  xlab("pseudobulk expression (logcpm) unmod")+
  ylab("pseudobulk expression (logcpm) unmod_n1")+
  theme_bw()+

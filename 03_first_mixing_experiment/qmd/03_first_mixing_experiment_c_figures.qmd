...
ggplot(cd, aes(x = total, y = total_mito_percent)) +
  ...
  facet_wrap(~factor(sample_id,levels=c("mixing_unmod","mixing_unmod_n1"))) + 
...
sce_filt <- sce[,sce$total>1400 & mito>2 & mito<28]
...
ggplot(df, aes(x = tso_total, y = wta_total, color = log_1p_tso_ontarget_multi)) +
  ...
  theme(
    ...
    strip.text = element_text(size = 15, face = "bold"))+
  facet_wrap(~factor(sample_id, levels = c("mixing_unmod", 
                                           "mixing_unmod_n1")))+
...
ggplot(data=plottable,
       aes(y=value,x=variable,color=factor(sample,levels=c("mixing_unmod","mixing_unmod_n1")))) +
  geom_point()+
  xlab(" ")+
  ylab("percent positive cells")+
  theme_bw()+
...
ggplot(data=plottable,aes(y=value,x=factor(sample,levels=c("mixing_unmod","mixing_unmod_n1")),color=variable)) +
  geom_point()+
  xlab(" ")+
  ylab("percent positive cells")+
  theme_bw()+
...
ggplot(data=plottable,aes(y=value,x=variable,fill=factor(sample,levels=c("mixing_unmod","mixing_unmod_n1")))) +
...
ggplot(data=plottable,aes(y=value,x=variable,color=factor(sample,levels=c("mixing_unmod","mixing_unmod_n1")))) +
  geom_point()+
  xlab(" ")+
  ylab("percent positive cells")+
  theme_bw()+

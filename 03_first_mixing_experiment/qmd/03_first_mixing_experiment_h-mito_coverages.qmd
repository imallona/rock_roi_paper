...
bed_6 <- as.data.frame(read.table(file.path(datadir,"match_6.bed"),header = FALSE, sep="\t",stringsAsFactors=FALSE, quote=""))
bed_5 <- as.data.frame(read.table(file.path(datadir,"match_5.bed"),header = FALSE, sep="\t",stringsAsFactors=FALSE, quote=""))
bed_4 <- as.data.frame(read.table(file.path(datadir,"match_4.bed"),header = FALSE, sep="\t",stringsAsFactors=FALSE, quote=""))

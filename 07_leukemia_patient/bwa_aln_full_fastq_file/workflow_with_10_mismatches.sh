...
bwa aln $WD/bwa_aln_10/genome/indexed -t $NTHREADS $cdna_patient -n 10 -k 4 > bwa_aln_alignments.sai

bwa samse -f bwa_aln_alignments.sam $WD/bwa_aln_10/genome/indexed bwa_aln_alignments.sai $cdna_patient

...
# the regions to extract for BCR and ABL are in the .bed file
...
rm ./star_fusion/output/sub_Chimeric.out.junction
...
rm ./star_fusion/output/p_counts_star_fusion.txt ./count_tables/star_fusion/counts_star_fusion_complete.txt

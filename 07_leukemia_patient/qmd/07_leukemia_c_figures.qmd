...
## Dot plot with monocyte markers

```{r}

monocytes_sce_nd<-fusion_db_sces_nd[,fusion_db_sces_nd$ident=="monocytes"]
positive_monocytes_sce_nd<-monocytes_sce_nd[,monocytes_sce_nd$positive_cells_gene_fusion_num_14865_id_6899__BCR_ABL1>0]
negative_monocytes_sce_nd<-monocytes_sce_nd[,monocytes_sce_nd$positive_cells_gene_fusion_num_14865_id_6899__BCR_ABL1==0]
...
short_markers<-as.vector(sapply(strsplit(markers,"--"),"[",2))
short_sces<-positive_monocytes_sce_nd[markers,]
rownames(short_sces)<-short_markers
...
ggsave(file=file.path(datadir,"positive_monocyte_markers.svg"), plot=plot11, width=3.5, height=2.7)

# negative cells

short_markers<-as.vector(sapply(strsplit(markers,"--"),"[",2))
short_sces<-negative_monocytes_sce_nd[markers,]
rownames(short_sces)<-short_markers
...
ggsave(file=file.path(datadir,"negative_monocyte_markers.svg"), plot=plot11, width=3.5, height=2.7)

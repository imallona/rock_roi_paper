---
title: "05_FACS_plots_e_reproducibility"
author: "Giulia Moro"
format: 
  html:
    toc: true
...
rdss <- dir(here("05_facs_plots/data/v2_reproducibility"), "*.fcs", 
...
titration<-titration[c(2,3,1,8,5,4,7,6)]

sampleNames(titration)<-c("pos_dt","pos_TSO","neg","unmod","rep1_gfp","rep1_dt","rep2_gfp","rep2_dt")
pData(titration)$name<-c("pos_dt","pos_TSO","neg","unmod","rep1_gfp","rep1_dt","rep2_gfp","rep2_dt")
...
ggcyto(titration, aes(x = FSC.A, y = SSC.A)) + 
  geom_hex(bins = 100) + 
  facet_wrap(~factor(name, levels = c("pos_dt","pos_TSO","neg","unmod","rep1_gfp","rep1_dt","rep2_gfp","rep2_dt"))) +
  geom_gate(beads) + 
...
ggcyto(filt_titration, aes(x = "APC-A", fill = name,color=name)) + 
  ...
  facet_wrap(~factor(name, levels = c("pos_dt","pos_TSO","neg","unmod","rep1_gfp","rep1_dt","rep2_gfp","rep2_dt")),ncol=1,switch = "y")+
  theme_bw() +
...
ggplot(plottable,aes(x=factor(L1,levels=c("pos_dt","pos_TSO","neg","unmod","rep1_gfp","rep1_dt","rep2_gfp","rep2_dt")),y=value))+

---
title: "05_FACS_plots_b_beads_with_heating"
author: "Giulia Moro"
format: 
  html:
    toc: true
...
rdss <- dir(here("05_facs_plots/data/beads with heating"), "*.fcs", 
...
titration<-titration[c(9,1,6,10,8,7,5,4,3,2)]

sampleNames(titration)<-c("pos_dt","pos_TSO","neg","unmod","100_TSO","100_dt","heat_TSO","heat_dt","heat_37_TSO","heat_37_dt")
pData(titration)$name<-c("pos_dt","pos_TSO","neg","unmod","100_TSO","100_dt","heat_TSO","heat_dt","heat_37_TSO","heat_37_dt")
...
sqrcut <- matrix(c(57000,60000,70000,80000,90000,100000,120000,110000,90000,80000,70000,60000,57000,
                   57000,100000,105000,120000,120000,115000,90000,65000,55000,53000,55000,57000,57000),ncol=2,nrow=13)
...
ggcyto(titration, aes(x = FSC.A, y = SSC.A)) + 
  geom_hex(bins = 100) + 
  facet_wrap(~factor(name, levels = c("pos_dt","pos_TSO","neg","unmod","100_TSO","100_dt","heat_TSO","heat_dt","heat_37_TSO","heat_37_dt"))) +
  geom_gate(beads) + 
...
ggcyto(filt_titration, aes(x = "APC-A", fill = name,color=name)) + 
  ...
  facet_wrap(~factor(name, levels = c("pos_dt","pos_TSO","neg","unmod","100_TSO","100_dt","heat_TSO","heat_dt","heat_37_TSO","heat_37_dt")),ncol=1,switch = "y")+
  theme_bw() +
...
ggplot(plottable,aes(x=factor(L1,levels=c("pos_dt","pos_TSO","neg","unmod","100_TSO","100_dt","heat_TSO","heat_dt","heat_37_TSO","heat_37_dt")),y=value))+

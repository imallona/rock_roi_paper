...
rdss <- dir(here("05_facs_plots/data/pdgfra"), "*.fcs", 
...
titration<-titration[c(6,7,5,4,1,2,3)]

sampleNames(titration)<-c("pos_dt","pos_TSO","neg","mod_egfp","mod_17","mod_7","mod_dT")
pData(titration)$name<-c("pos_dt","pos_TSO","neg","mod_egfp","mod_17","mod_7","mod_dT")
...
sqrcut <- matrix(c(50000,60000,70000,80000,90000,100000,110000,100000,90000,80000,70000,60000,50000,
                   60000,85000,90000,95000,95000,80000,70000,45000,40000,38000,40000,45000,60000),ncol=2,nrow=13)
...
ggcyto(titration, aes(x = FSC.A, y = SSC.A)) + 
  geom_hex(bins = 100) + 
  facet_wrap(~factor(name, levels = c("pos_dt","pos_TSO","neg","mod_egfp","mod_17","mod_7","mod_dT"))) +
  geom_gate(beads) + 
...
ggcyto(filt_titration, aes(x = "APC-A", fill = name,color=name)) + 
  ...
  facet_wrap(~factor(name, levels = c("pos_dt","pos_TSO","neg","mod_egfp","mod_17","mod_7","mod_dT")),ncol=1,switch = "y")+
  theme_bw() +
...
ggplot(plottable,aes(x=factor(L1,levels=c("pos_dt","pos_TSO","neg","mod_egfp","mod_17","mod_7","mod_dT")),y=value))+

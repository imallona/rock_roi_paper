---
title: "05_FACS_plots_g_splint_activity"
author: "Giulia Moro"
format: 
  html:
    toc: true
...
rdss <- dir(here("05_facs_plots/data/exo_v2_and_storage"), "*.fcs", 
...
titration<-titration[c(8,9,3,10,2,1,5,4,7,6)]

sampleNames(titration)<-c("pos_dt","pos_TSO","neg","unmod","100_gfp","100_dt","no_enzyme_gfp","no_enzyme_dt","no_exo_gfp","no_exo_dt")
pData(titration)$name<-c("pos_dt","pos_TSO","neg","unmod","100_gfp","100_dt","no_enzyme_gfp","no_enzyme_dt","no_exo_gfp","no_exo_dt")
...
ggcyto(titration, aes(x = FSC.A, y = SSC.A)) + 
  geom_hex(bins = 100) + 
  facet_wrap(~factor(name, levels = c("pos_dt","pos_TSO","neg","unmod","100_gfp","100_dt","no_enzyme_gfp","no_enzyme_dt","no_exo_gfp","no_exo_dt"))) +
  geom_gate(beads) + 
...
ggcyto(filt_titration, aes(x = "APC-A", fill = name,color=name)) + 
  ...
  facet_wrap(~factor(name, levels = c("pos_dt","pos_TSO","neg","unmod","100_gfp","100_dt","no_enzyme_gfp","no_enzyme_dt","no_exo_gfp","no_exo_dt")),ncol=1,switch = "y")+
  theme_bw() +
...
ggplot(plottable,aes(x=factor(L1,levels=c("pos_dt","pos_TSO","neg","unmod","100_gfp","100_dt","no_enzyme_gfp","no_enzyme_dt","no_exo_gfp","no_exo_dt")),y=value))+

...
plotTracks(c(coverage_chr_pdgfra[["unmod_wta"]],
            ...
            showSampleNames = TRUE,
            lwd.title=0.5,
            ylim=c(0,4000)) # seen from plot above that the max is 4000
...
for (i in modality){
    overlays_pdgfra[[paste0(i,"_",x)]]<-OverlayTrack(trackList=list(coverage_chr_pdgfra[[paste0(i,"_wta")]],coverage_chr_pdgfra[[paste0(i,"_tso")]]))
}
...
for (i in modality){
  ranges_bam[paste0("ylims_",i,"_",x)]<-extendrange(range(c(values(covs_pdgfra[[paste0(i,"_wta")]]), 
                                                            values(covs_pdgfra[[paste0(i,"_tso")]]))))[[2]]
}
  
plotTracks(c(overlays_bam_pdgfra[[paste0("unmod_",x)]],
             overlays_pdgfra[[paste0("unmod_",x)]],
             overlays_bam_pdgfra[[paste0("rockroi_",x)]],
             overlays_pdgfra[[paste0("rockroi_",x)]],
             gm_pdgfra),
           type="histogram",
           from=region_start,
           to=region_end,
...
### Plot with the two regions where have the ROI primers 

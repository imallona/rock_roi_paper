...
rownames(altExp(sces))
sort(rowSums(assay(altExp(sces), 1)), decreasing = TRUE)

# sces$`between_roi_egfp:770-1049` <- assay(altExp(sces), 1)["between_roi_egfp:770-1049",]
...
# plotUMAP(sces, colour_by = "between_roi_egfp:770-1049", 
...
# z <- assay(altExp(sces), 1) > 0


mm <- sces[,sces$sample_id=="pdgfra_rockroi_multimodal"]

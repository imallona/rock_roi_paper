...
for (i in names(coverage_egfp)){
  displayPars(coverage_egfp[[i]])<-list(col.histogram="black",
                                        fill.histogram=TRUE)
}
...
for (i in names(coverage_tdtomato)){
  displayPars(coverage_tdtomato[[i]])<-list(col.histogram="black",
                                            fill.histogram=TRUE)
}
...
displayPars(coverage_egfp$unmod_wta)<-list(col.histogram="pink",
                                           fill.histogram="pink",
                                           alpha.title = 1, 
                                           alpha = 0.3)

displayPars(coverage_egfp$unmod_tso)<-list(col.histogram="lightblue",
...
displayPars(coverage_egfp$unmod_roi_wta)<-list(col.histogram="pink",
                                               fill.histogram="pink",
                                               alpha.title = 1, 
                                               alpha = 0.3)

displayPars(coverage_egfp$unmod_roi_tso)<-list(col.histogram="lightblue",
                                               fill.histogram="lightblue",
                                               alpha.title = 1, 
                                               alpha = 0.3)

ylims_rock_egfp <- extendrange(range(c(values(coverage_egfp$rock_wta), values(coverage_egfp$rock_tso))))
displayPars(coverage_egfp$rock_wta)<-list(col.histogram="pink",
                                          fill.histogram="pink",
                                          alpha.title = 1, 
                                          alpha = 0.3)

displayPars(coverage_egfp$rock_tso)<-list(col.histogram="lightblue",
                                          fill.histogram="lightblue",
                                          alpha.title = 1, 
                                          alpha = 0.3)

ylims_rockroi_egfp <- extendrange(range(c(values(coverage_egfp$rockroi_wta), values(coverage_egfp$rockroi_tso))))
displayPars(coverage_egfp$rockroi_wta)<-list(col.histogram="pink",
                                             fill.histogram="pink",
                                             alpha.title = 1, 
                                             alpha = 0.3)
displayPars(coverage_egfp$rockroi_tso)<-list(col.histogram="lightblue",
                                             fill.histogram="lightblue",                                             
                                             alpha.title = 1, 
                                             alpha = 0.3)
...
unmod_egfp<-OverlayTrack(trackList=list(coverage_egfp$unmod_wta,coverage_egfp$unmod_tso))
unmod_roi_egfp<-OverlayTrack(trackList=list(coverage_egfp$unmod_roi_wta,coverage_egfp$unmod_roi_tso))
rock_egfp<-OverlayTrack(trackList=list(coverage_egfp$rock_wta,coverage_egfp$rock_tso))
rockroi_egfp<-OverlayTrack(trackList=list(coverage_egfp$rockroi_wta,coverage_egfp$rockroi_tso))
...
displayPars(coverage_tdtomato$unmod_wta)<-list(col.histogram="pink",
                                               fill.histogram="pink",
                                               alpha.title = 1, 
                                               alpha = 0.3)

displayPars(coverage_tdtomato$unmod_tso)<-list(col.histogram="lightblue",
                                               fill.histogram="lightblue",
                                               alpha.title = 1, 
                                               alpha = 0.3)
...
displayPars(coverage_tdtomato$unmod_roi_wta)<-list(col.histogram="pink",
                                                   fill.histogram="pink",
                                                   alpha.title = 1, 
                                                   alpha = 0.3)

displayPars(coverage_tdtomato$unmod_roi_tso)<-list(col.histogram="lightblue",
                                                   fill.histogram="lightblue",
                                                   alpha.title = 1, 
                                                   alpha = 0.3)

ylims_rock_tdtomato <- extendrange(range(c(values(coverage_tdtomato$rock_wta), values(coverage_tdtomato$rock_tso))))
displayPars(coverage_tdtomato$rock_wta)<-list(col.histogram="pink",
                                              fill.histogram="pink",
                                              alpha.title = 1, 
                                              alpha = 0.3)

displayPars(coverage_tdtomato$rock_tso)<-list(col.histogram="lightblue",
                                              fill.histogram="lightblue",
                                              alpha.title = 1, 
                                              alpha = 0.3)

ylims_rockroi_tdtomato <- extendrange(range(c(values(coverage_tdtomato$rockroi_wta), values(coverage_tdtomato$rockroi_tso))))
displayPars(coverage_tdtomato$rockroi_wta)<-list(col.histogram="pink",
                                                 fill.histogram="pink",
                                                 alpha.title = 1, 
                                                 alpha = 0.3)

displayPars(coverage_tdtomato$rockroi_tso)<-list(col.histogram="lightblue",
                                                 fill.histogram="lightblue",
                                                 alpha.title = 1, 
                                                 alpha = 0.3)
...
unmod_tdtomato <-OverlayTrack(trackList=list(coverage_tdtomato$unmod_wta,coverage_tdtomato$unmod_tso))
unmod_roi_tdtomato<-OverlayTrack(trackList=list(coverage_tdtomato$unmod_roi_wta,coverage_tdtomato$unmod_roi_tso))
rock_tdtomato<-OverlayTrack(trackList=list(coverage_tdtomato$rock_wta,coverage_tdtomato$rock_tso))
rockroi_tdtomato<-OverlayTrack(trackList=list(coverage_tdtomato$rockroi_wta,coverage_tdtomato$rockroi_tso))
...
unmod_egfp_bam<-OverlayTrack(trackList=list(covs_egfp$unmod_wta,covs_egfp$unmod_tso))
unmod_roi_egfp_bam<-OverlayTrack(trackList=list(covs_egfp$unmod_roi_wta,covs_egfp$unmod_roi_tso))
rock_egfp_bam<-OverlayTrack(trackList=list(covs_egfp$rock_wta,covs_egfp$rock_tso))
rockroi_egfp_bam<-OverlayTrack(trackList=list(covs_egfp$rockroi_wta,covs_egfp$rockroi_tso))
...
unmod_tdtomato_bam<-OverlayTrack(trackList=list(covs_tdtomato$unmod_wta,covs_tdtomato$unmod_tso))
unmod_roi_tdtomato_bam<-OverlayTrack(trackList=list(covs_tdtomato$unmod_roi_wta,covs_tdtomato$unmod_roi_tso))
rock_tdtomato_bam<-OverlayTrack(trackList=list(covs_tdtomato$rock_wta,covs_tdtomato$rock_tso))
rockroi_tdtomato_bam<-OverlayTrack(trackList=list(covs_tdtomato$rockroi_wta,covs_tdtomato$rockroi_tso))
...
### Zooming into polyA tail of transcript for eGFP since cannot add an extra y axis on the right side, that way can see the wta for all the tracks

```{r}

# need to subset object so that can then set the ylim based on the region of interest and not the whole transcript --> make a GRanges

chr<-"egfp"
region_start<-gm_egfp@end-400
region_end<-gm_egfp@end

tail_egfp <- GRanges(chr,IRanges(region_start,region_end))
tail_param_egfp <- ScanBamParam(which=tail_egfp)

tail_egfp_gals <- lapply(bam, function(x) {
  readGAlignments(x, use.names = TRUE, param=tail_param_egfp)
  })

tail_covs_egfp<-lapply(tail_egfp_gals,coverage)
tail_covs_egfp<-lapply(tail_covs_egfp,function(x) as(x,"GRanges"))

for (i in 1:length(tail_covs_egfp)){
  tail_covs_egfp[[i]]<-DataTrack(tail_covs_egfp[[i]],
                                chromosome=chr,
                                name=names(tail_covs_egfp)[[i]])
}

for (i in names(tail_covs_egfp)){
  displayPars(tail_covs_egfp[[i]])<-list(col.histogram="black",fill.histogram=TRUE)
}

for (i in 1:length(tail_covs_egfp)){
  tail_covs_egfp[[i]]@name<-gsub(c("_wta","_tso"),"",tail_covs_egfp[[i]]@name)
}

tail_unmod_egfp_bam<-OverlayTrack(trackList=list(tail_covs_egfp$unmod_wta,tail_covs_egfp$unmod_tso))
tail_unmod_roi_egfp_bam<-OverlayTrack(trackList=list(tail_covs_egfp$unmod_roi_wta,tail_covs_egfp$unmod_roi_tso))
tail_rock_egfp_bam<-OverlayTrack(trackList=list(tail_covs_egfp$rock_wta,tail_covs_egfp$rock_tso))
tail_rockroi_egfp_bam<-OverlayTrack(trackList=list(tail_covs_egfp$rockroi_wta,tail_covs_egfp$rockroi_tso))

plotTracks(c(tail_unmod_egfp_bam,
             unmod_egfp,
             tail_unmod_roi_egfp_bam,
             unmod_roi_egfp,
             tail_rock_egfp_bam,
             rock_egfp,
             tail_rockroi_egfp_bam,
             rockroi_egfp),
           type="histogram",
           from=gm_egfp@end-400,
           end=gm_egfp@end,
           cex.axis =0.5,
           cex.title=0.8,
           background.title="cadetblue2",
           ...
           showSampleNames = TRUE,
           lwd.title=0.5,
           ylim=c(0,max(range(values(tail_covs_egfp$unmod_wta)),
                        range(values(tail_covs_egfp$unmod_roi_wta)),
                        range(values(tail_covs_egfp$rock_wta)),
                        range(values(tail_covs_egfp$rockroi_wta))
                        )))
...
chr<-"tdtomato"
region_start<-gm_tdtomato@end-400
region_end<-gm_tdtomato@end

tail_tdtomato <- GRanges(chr,IRanges(region_start,region_end))
tail_param_tdtomato <- ScanBamParam(which=tail_tdtomato)

tail_tdtomato_gals <- lapply(bam, function(x) {
  readGAlignments(x, use.names = TRUE, param=tail_param_tdtomato)
  })

tail_covs_tdtomato<-lapply(tail_tdtomato_gals,coverage)
tail_covs_tdtomato<-lapply(tail_covs_tdtomato,function(x) as(x,"GRanges"))

for (i in 1:length(tail_covs_tdtomato)){
  tail_covs_tdtomato[[i]]<-DataTrack(tail_covs_tdtomato[[i]],
                                chromosome=chr,
                                name=names(tail_covs_tdtomato)[[i]])
}

for (i in names(tail_covs_tdtomato)){
  displayPars(tail_covs_tdtomato[[i]])<-list(col.histogram="black",fill.histogram=TRUE)
}

for (i in 1:length(tail_covs_tdtomato)){
  tail_covs_tdtomato[[i]]@name<-gsub(c("_wta","_tso"),"",tail_covs_tdtomato[[i]]@name)
}

tail_unmod_tdtomato_bam<-OverlayTrack(trackList=list(tail_covs_tdtomato$unmod_wta,tail_covs_tdtomato$unmod_tso))
tail_unmod_roi_tdtomato_bam<-OverlayTrack(trackList=list(tail_covs_tdtomato$unmod_roi_wta,tail_covs_tdtomato$unmod_roi_tso))
tail_rock_tdtomato_bam<-OverlayTrack(trackList=list(tail_covs_tdtomato$rock_wta,tail_covs_tdtomato$rock_tso))
tail_rockroi_tdtomato_bam<-OverlayTrack(trackList=list(tail_covs_tdtomato$rockroi_wta,tail_covs_tdtomato$rockroi_tso))

plotTracks(c(tail_unmod_tdtomato_bam,
             unmod_tdtomato,
             tail_unmod_roi_tdtomato_bam,
             unmod_roi_tdtomato,
             tail_rock_tdtomato_bam,
             rock_tdtomato,
             tail_rockroi_tdtomato_bam,
             rockroi_tdtomato),
           type="histogram",
           from=gm_tdtomato@end-400,
           end=gm_tdtomato@end,
           cex.axis =0.5,
           cex.title=0.8,
           background.title="cadetblue2",
           ...
           showSampleNames = TRUE,
           lwd.title=0.5,
           ylim=c(0,max(range(values(tail_covs_tdtomato$unmod_wta)),
                        range(values(tail_covs_tdtomato$unmod_roi_wta)),
                        range(values(tail_covs_tdtomato$rock_wta)),
                        range(values(tail_covs_tdtomato$rockroi_wta))
                        )))

### It s the same plot for both egfp and tdtomato (as expected since the sequence is the same between egfp and tdtom)

...
combined_no_tx$color[which(combined_no_tx$egfp_detection_score==0 & combined_no_tx$tdtom_detection_score==0)]<-"grey" # no detection of either
...
g <- ggplot(combined_no_tx, aes(
  x = subsets_mouse_gene_sum,
  y = subsets_human_gene_sum,
  color = color  # Specify color within aes()
)) +
  ...
  labs(title="egfp and tdtomato detection")+

...
cd <- colData(altExp(sce_filt,"tso_ontarget_multi",withColData=TRUE))
ae <- altExp(sce_filt,"tso_ontarget_multi",withColData=TRUE)

cd$tso_egfp_detection_score <- 0
cd$tso_egfp_detection_score[ae$egfp_tx>0] <- 1
cd$tso_egfp_detection_score[ae$egfp_cds>0] <- 2
cd$tso_egfp_detection_score[ae$egfp_roi>0] <- 3
cd$tso_egfp_detection_score[ae$egfp_roi>0] <- 4

cd$tso_tdtom_detection_score<-0
cd$tso_tdtom_detection_score[ae$tdtom_tx>0] <- 1
cd$tso_tdtom_detection_score[ae$tdtom_cds>0] <- 2
cd$tso_tdtom_detection_score[ae$tdtom_roi1>0] <- 3
cd$tso_tdtom_detection_score[ae$tdtom_roi2>0] <- 3
cd$tso_tdtom_detection_score[ae$tdtom_roi2>0 & ae$tdtom_roi1>0] <- 4

table(cd$tso_egfp_detection_score)
table(cd$tso_tdtom_detection_score)
